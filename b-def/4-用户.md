...
<img src="https://raw.githubusercontent.com/hughxusu/lesson-py/developing/_images/base/Distance-Between-Two-Points-Step-2.jpg.webp" style="zoom:70%;" />
...
> [!tip]
>
> 编写一个计算两个向量的欧式距离函数，两个向量为： `x = [5.0, 3.3, 1.4, 0.2]`、`y = [7.0, 3.2, 4.7, 1.4]`
