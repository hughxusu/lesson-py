...
<img src="https://raw.githubusercontent.com/hughxusu/lesson-py/developing/_images/base/Xnip2024-04-30_17-38-33.jpg" style="zoom: 33%;" />
...
1. 不可变变量，部分相同的值指向相同的存储地址；部分相同值开辟新的存储空间。
...
> [!warning]
>
> 在不同版本的Python，和不同的开发环境中，分配方式有所差别。比较`.py`和`.ipynb`的运行结果。

2. 可变变量初始化相同的值，会指向不同的内存。
