...
| 名称     | 序列类型 | 是否可变             | 索引方式 | 布尔测试为`False` |
| -------- | -------- | -------------------- | -------- | ----------------- |
| `string` | 连续     | 不可变，元素不可删除 | 序号     | `bool('')`        |
| `tuple`  | 连续     | 不可变，元素不可删除 | 序号     | `bool(typle())`   |
| `list`   | 连续     | 可变，元素可删除     | 序号     | `bool([])`        |
| `dict`   | 无序     | 可变，元素可删除     | 键       | `bool({})`        |
| `set`    | 无序     | 可变，元素可删除     | 不可索引 | `bool(set())`     |
