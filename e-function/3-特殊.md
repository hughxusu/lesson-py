...
<img src="https://pic2.zhimg.com/80/v2-74704e7bf8edf09f5d318596f9cb0889_1440w.webp" style="zoom:80%;" />
...
<img src="http://reactivex.io/documentation/operators/images/map.png" style="zoom:55%;" />
...
<img src="http://reactivex.io/documentation/operators/images/reduce.png" style="zoom: 55%;" />
...
<img src="http://reactivex.io/documentation/operators/images/filter.png" style="zoom: 55%;" />

## 函数使用的一些注意事项

1. 不要编写太长的函数，对于 Python 语言来说，超过65是一个危险的信号。
2. Python 语言中对递归限制较多，尽可能使用循环来代替递归。
