...
<img src="https://raw.githubusercontent.com/hughxusu/lesson-py/develop/images/base/Xnip2026-03-25_22-54-30.jpg" style="zoom:55%;" />

### 模块中的私有化

在包中使用`_xx`单前置下划线的变量、函数和类，无法使用`from xx import yy`。
