...
```python
fn = lambda *args: sum(args) / len(args)
...
<img src="./assets/map.png" style="zoom:45%;" />
...
<img src="./assets/reduce.png" style="zoom: 45%;" />
...
<img src="./assets/filter.png" style="zoom: 45%;" />
