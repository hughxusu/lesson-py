...
计算机硬件只能执行二进制指令，程序员所写的程序需要转换成二进制指令计算机才能执行。将其程序转换为二进制指令的工具，被称为编译器。编译器的工作方式有两种：一个是编译，另外一个是解释。
...
3. 深度学习、数据分析等工作利器。
4. 对于数学专业可以完全代替Matlab工具。

<img src="https://raw.githubusercontent.com/hughxusu/lesson-py/develop/images/base/Python语言.jpg" style="zoom:65%;" />
